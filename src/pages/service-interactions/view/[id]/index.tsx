...
import { getServiceInteractionById } from 'apiSdk/service-interactions';
...
function ServiceInteractionViewPage() {
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          <Text as="h1" fontSize="2xl" fontWeight="bold">
            Service Interaction Detail View
          </Text>
          {hasAccess('service_interaction', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/service-interactions/edit/${data?.id}`} passHref legacyBehavior>
              <Button
