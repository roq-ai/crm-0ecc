...
import { getSalesOpportunityById } from 'apiSdk/sales-opportunities';
...
function SalesOpportunityViewPage() {
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          ...
          {hasAccess('sales_opportunity', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/sales-opportunities/edit/${data?.id}`} passHref legacyBehavior>
              <Button
